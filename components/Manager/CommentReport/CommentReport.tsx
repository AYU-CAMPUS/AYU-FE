...
import * as Styled from "./CommentReport.style";
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="center">신고자 아아디</TableCell>
          ...
          <TableBody>
            {TableData.map(row => (
              <TableRow key={row.id}>
                ...
                <TableCell align="center">{row.commentData}</TableCell>
                <TableCell align="center">{row.reason}</TableCell>
                <TableCell align="center">{row.reporterId}</TableCell>
